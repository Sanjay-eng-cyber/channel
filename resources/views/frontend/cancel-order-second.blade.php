...
@section('title', 'Cancel Orders Second |')
@section('cdn')
            ...
            <div class="col-lg-12 col-xl-6">
                ...
                <div class="p-4  or-secondpage-fcard">
                    ...
                    <div class="or-secondpage-fcard-top ">
                        <h5 class="main-head or-secondpage-fcard-head d-flex align-items-start gap-1 text-cappitalize ">
                            <img src="frontend/images/icons/icon-notation.svg" alt="" class="img-fluid" style="width:24px">
                            Your Order Has Been Cancelled
                        </h5>

                        <ul>
                            <li><div class="text-capitalize">product damaged but shipping box ok </div></li>
                            <li><div class="text-capitalize">image uploaded</div></li>
                        </ul>
                ...
                <div class="p-4 my-4 or-secondpage-fscard">
                        <div class="gap-2 or-secondpage-fs-top">
                                <div class="or-secondpage-fscard-top">
                                    <h5 class="main-head  or-secondpage-fscard-head d-none d-md-block text-capitalize" style="">How can we make it right?</h5>

                                    <h5 class="main-head  or-secondpage-fscard-head pt-3 pb-1 text-capitalize">Talk to customer service </h5>
                                ...
                                <div class="or-secondpage-fscard-imgTop">
                                    <h5 class="main-head  or-secondpage-fscard-head d-block d-md-none text-capitalize" style="">How Can We Make It Right?</h5>
