    ...
    <section class="pb-3">
        <div class="container">
            <div class="row main-group-card">
                ...
                <h3 class="py-3">Terms & Conditions</h3>
                <p>This website is operated by ChannelThroughout the site, the terms “we”, “us” and
                    “our” refer to Channel offers this website, including all information, tools and services
                ...
                <h6 class="pb-3">SECTION 1 - ONLINE STORE TERMS</h6>
                ...
                <p>A breach or violation of any of the Terms will result in an immediate termination of
                    your Services. </p>
                <h6 class="pb-3">SECTION 2 - GENERAL CONDITIONS </h6>
                <p>
                ...
                <p>You agree not to reproduce, duplicate, copy, sell, resell or exploit any portion of the
                ...
                <h6 class="pb-3">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF
                    INFORMATION </h6>
                ...
                <h6 class="pb-3">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES </h6>
                ...
                <h6 class="pb-3">SECTION 5 - PRODUCTS OR SERVICES (if applicable) </h6>
                ...
                <p>We reserve the right, but are not obligated, to limit the sales of our products or
                    ...
                    change at any time without notice, at the sole discretion of us. We reserve the right
                ...
                <h6 class="pb-3">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h6>
                ...
                <h6 class="pb-3">SECTION 7 - OPTIONAL TOOLS </h6>
                ...
                <h6 class="pb-3">SECTION 8 - THIRD-PARTY LINKS </h6>
                ...
                <h6 class="pb-3">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h6>
                ...
                <p>You agree that your comments will not violate any right of any third-party, including
                    ...
                    party. </p>
                <h6 class="pb-3">SECTION 10 - PERSONAL INFORMATION </h6>
                ...
                <h6 class="pb-3">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS </h6>
                ...
                <p>We undertake no obligation to update, amend or clarify information in the Service or
                    ...
                    any related website has been modified or updated.</p>
                <h6 class="pb-3">SECTION 12 - PROHIBITED USES </h6>
                ...
                <h6 class="pb-3">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h6>
                ...
                <p>We do not warrant that the results that may be obtained from the use of the service
                    will be accurate or reliable.</p>
                <p>You agree that from time to time we may remove the service for indefinite periods of
                    time or cancel the service at any time, without notice to you. </p>
                <p>You expressly agree that your use of, or inability to use, the service is at your sole
                    ...
                    infringement.</p>
                <p>In no case shall Channel, our directors, officers, employees, affiliates, agents,
                ...
                <h6 class="pb-3">SECTION 14 - INDEMNIFICATION</h6>
                <p>You agree to indemnify, defend and hold harmless Channel and our parent,
                ...
                <h6 class="pb-3">SECTION 15 – SEVERABILITY</h6>
                ...
                <h6 class="pb-3">SECTION 16 – TERMINATION </h6>
                ...
                <h6 class="pb-3">SECTION 17 - ENTIRE AGREEMENT</h6>
                ...
                <p>These Terms of Service and any policies or operating rules posted by us on this site
                ...
                <h6 class="pb-3">SECTION 18 - GOVERNING LAW </h6>
                <p>These Terms of Service and any separate agreements whereby we provide you
                    Services shall be governed by and construed in accordance with the laws of Shop no
                    5&6, Sunview Apartment, Tilak Nagar,Chembur, Mumbai, 400089, India.</p>
                <h6 class="pb-3">SECTION 19 - CHANGES TO TERMS OF SERVICE </h6>
