                ...
                <div class="widget-header">
                            ...
                            <nav class="breadcrumb-two" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a
                                            href="javascript:void(0);">Brands</a></li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="align-items-center col-xl-5 col-lg-4 col-md-12 col-sm-12 d-flex justify-content-end row mb-2">
                            <a href="{{ route('backend.brand.create') }}" name="txt"
                            ...
                            <table class="table mb-4">
                                ...
                                <tbody>
                                    @forelse($brands as $brand)
                                        <tr>
                                            <td>{{ tableRowSrNo($loop->index, $brands) }}</td>
                                            <td>{{ $brand->name }}</td>
                                            {{-- <td>
                                                ...
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        {{-- <a class="dropdown-item"
                                                            href="{{ route('backend.brand.show', $brand->id) }}">View</a> --}}
                                                        <a class="dropdown-item"
                                                            href="{{ route('backend.brand.edit', $brand->id) }}">Edit</a>
                                                            <a class="dropdown-item"
                                                            href="{{ route('backend.brand.destroy', $brand->id) }}">Delete</a>
                                                    </div>
                                                </div>
